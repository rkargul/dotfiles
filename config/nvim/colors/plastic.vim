...
let s:black = { 'gui': '#c5c8c6', 'cterm256': '234'}
let s:visual_black = { 'gui': '#c5c8c6', 'cterm256': 'NONE'}
let s:background = {'gui': '#c5c8c6', 'cterm256': '235'}
let s:foreground = {'gui': '#c5c8c6', 'cterm256': '235'}
let s:grey = { 'gui': '#abb2bf', 'cterm256': '59' }
let s:punctuation = { 'gui': '#7c8696', 'cterm256': '238' }
let s:none = {'gui': '#c5c8c6', 'cterm256': 'NONE'}
